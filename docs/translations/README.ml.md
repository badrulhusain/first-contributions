...
```bash
git clone https://github.com/<നിങ്ങളുടെ ഗിറ്റ്ഹബിലെ പേര്>/first-contributions.git
```

ഇതിൽ `<നിങ്ങളുടെ ഗിറ്റ്ഹബിലെ പേര്>` എന്നതിന് പകരം നിങ്ങളുടെ ഗിറ്റ്ഹബ് യൂസർനെയിം കൊടുക്കുക. ഇപ്പോൾ നിങ്ങൾ ചെയ്യുന്നത് നിങ്ങളുടെ ഗിറ്റ്ഹബിലെ ഫസ്റ്റ്-കോണ്ട്രിബൂഷൻസ് (first-contributions) റെപ്പോസിറ്ററിയിൽ ഉള്ളവ നിങ്ങളുടെ കമ്പ്യൂട്ടറിലേക്ക് കോപ്പി ചെയ്യുകയാണ്.
...
```bash
git commit -m "Add <നിങ്ങളുടെ ഗിറ്റ്ഹബിലെ പേര്> to Contributors list"
```

ഇതിൽ `<നിങ്ങളുടെ ഗിറ്റ്ഹബിലെ പേര്>` എന്ന സ്ഥാനത്ത് താങ്കളുടെ ശരിയായ പേര് കൊടുക്കുക.
